  ...
  <div class="menu-container">
    ...
    <div class="cart-button-container">
      <router-link to="/cartpage" class="btn btn-primary">
        ...
        <span :class="['cart-count', { 'zero-count': totalItems === 0 }]">{{ totalItems }}</span>
      </router-link>
    </div>
    ...
    >
      <div class="button-row">
        <button
          v-for="(button, index) in carouselButtons"
          :key="index"
          type="button"
          :class="[
            'btn btn-lg btn-indicator text custom-button-width',
            {
        ...
        >
          <div class="button-content">
            ...
            <fa :icon="button.icon" class="icon" />
          </div>
        </button>
      </div>
